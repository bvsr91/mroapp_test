sap.ui.define(
    ...
    function (
        ...
        return BaseController.extend("com.ferre.mrouife.controller.App", {
            formatter: formatter,
            onInit: function () {
            ...
            handleNotificationPress: function (oEvent) {
                if (!this._oDialog1) {
                    this._oDialog1 = sap.ui.xmlfragment(
                        this.createId("frgNotification"),
                        "com.fe.mroecat.view.fragments.Notifications",
                        this
                    );
            ...
            onNotificationPress: function (oEvent) {
                if (!this._oDialog) {
                    this._oDialog = sap.ui.xmlfragment(
                        this.createId("frgMyInboxNotification"),
                        "com.fe.mroecat.view.fragments.MyInboxNotification",
                        this
                    );
